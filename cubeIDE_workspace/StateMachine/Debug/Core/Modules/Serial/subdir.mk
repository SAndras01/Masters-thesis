...
CPP_SRCS += \
../Core/Modules/Serial/Serial.cpp 

OBJS += \
./Core/Modules/Serial/Serial.o 

CPP_DEPS += \
./Core/Modules/Serial/Serial.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Modules/Serial/%.o Core/Modules/Serial/%.su Core/Modules/Serial/%.cyclo: ../Core/Modules/Serial/%.cpp Core/Modules/Serial/subdir.mk
...
clean: clean-Core-2f-Modules-2f-Serial

clean-Core-2f-Modules-2f-Serial:
	-$(RM) ./Core/Modules/Serial/Serial.cyclo ./Core/Modules/Serial/Serial.d ./Core/Modules/Serial/Serial.o ./Core/Modules/Serial/Serial.su

.PHONY: clean-Core-2f-Modules-2f-Serial
